...
namespace VMELE_E4
{
    public partial class frm_Listes : Form
    {
        ...
        private void setupDgvListeCommandes(Dictionary<int, cls_Commande> pDicoCommandes)
        {
            ...
            foreach (cls_Commande l_Commande in pDicoCommandes.Values)
            {
                ...
                table.Rows.Add(l_Commande.getID(), l_Commande.RefCommande, l_Commande.getEtatSoByID(l_Commande),
                    l_Commande.getUtilisateurByID(l_Commande), l_Commande.getClientByID(l_Commande),
    ...
    /// <param name="e"></param>
            ...
            pDicoLignesCommande)
        {
            ...
            foreach (cls_LigneCommande l_LigneCommande in pDicoLignesCommande.Values)
            {
                table.Rows.Add(l_LigneCommande.getID(),
                    ...
                    l_LigneCommande.getEtatSolByID(l_LigneCommande), 
                    l_LigneCommande.getProduitlByID(l_LigneCommande),
                    l_LigneCommande.Quantite, 
                    l_LigneCommande.getProduitlByID(l_LigneCommande).PrixConditionne + " €",
        ...
        {
            var databaseRecordId = dgv_listeCommandes.Rows[e.RowIndex].Cells[0].Value;
            MessageBox.Show(databaseRecordId.ToString());
        }
    }
}
